...
CElectrifiedWire::CElectrifiedWire()
	: m_bIsActive(true), m_iTipSparkFrequency(3), m_iBodySparkFrequency(100), m_iLightningFrequency(150), m_iXJoltForce(0), m_iYJoltForce(0), m_iZJoltForce(0), m_uiNumUninsulatedSegments(0)
{
}
...
void CElectrifiedWire::KeyValue(KeyValueData* pkvd)
{
	...
	{ BaseClass::KeyValue(pkvd); return; }
}
