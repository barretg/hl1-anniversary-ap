...
****/
//=========================================================
// Dr. Rosenberg (Blue Shift), ported from halflife-bs-updated/dlls/rosenberg.cpp
// to this SDK's conventions. A scientist with his own voice and pain sounds.
//=========================================================
...
void CRosenberg::TalkInit()
{
	...
	m_szFriends[0] = (char*)"monster_scientist";
	m_szFriends[1] = (char*)"monster_sitting_scientist";
	m_szFriends[2] = (char*)"monster_barney";
